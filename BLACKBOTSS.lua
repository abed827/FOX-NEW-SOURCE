...
local NameUser = "[- FoX 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/vFoX1)\n — — — — — — — — —\n⌔︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- FoX 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/vFoX1)\n — — — — — — — — —\n⌔︙اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
send(msg.chat_id_, msg.id_,"[- FoX 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/vFoX1)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "vFoX1")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
...
if BLACKBOTSSrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"[- FoX 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/vFoX1)\n — — — — — — — — —\n⌔︙العضو -› ["..result.title_.."](t.me/"..(text1[3] or "vFoX1")..")".."\n⌔︙تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."BLACKBOTSS:Special:User"..msg.chat_id_,result.id_)  
...
if text == (database:get(bot_id.."BLACKBOTSS:Name:Bot") or "فيونا") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."BLACKBOTSS:Name:Bot") or "فيونا")
local namebot = {
...
os.execute('wget https://raw.githubusercontent.com/abed827/FOX-TEAM/master/BLACKBOTSS.lua')
os.execute('wget https://raw.githubusercontent.com/abed827/FOX-TEAM/master/start.lua')
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- FoX 𝖲𝗈𝗎𝗋𝖼𝖾 .',url="t.me/vFoX1"}},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_,msg.id_,'⌔︙شترك في قناة السورس اولآ @vFoX1 .')   
return false 
end
Text = [[
*- FoX 𝖲𝗈𝗎𝗋𝖼𝖾 .*
...
inline = {
{{text = '⌔︙ BLacK 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/vFoX1'}},
}
...
local Name_Bot = (database:get(bot_id.."BLACKBOTSS:Name:Bot") or "فيونا")
...
>> The Bot is Running
>> Bot source > Black
>>Source channel > @vFoX1
>>Source developer > @FoXcV
 ____  _        _    ____ _  __
| __ )| |      / \  / ___| |/ /
|  _ \| |     / _ \| |   | ' / 
| |_) | |___ / ___ \ |___| . \ 
